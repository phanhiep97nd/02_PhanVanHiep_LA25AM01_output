...
public interface TblUserLogic {
	 ...
	 * @return trả về kết quả là giá trị boolean
	 * @throws SQLException
	 * @throws ClassNotFoundException
	 * @throws NoSuchAlgorithmException
	 */
	Boolean checkExistLogin(String loginName, String pass) throws ClassNotFoundException, SQLException, NoSuchAlgorithmException;
}
